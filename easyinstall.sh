...
if [ ! -e "~/twm/info.sh" ]; then
 curl https://raw.githubusercontent.com/OluasArieiv/furiabot/main/info.sh -s -L >$HOME/twm/info.sh
 chmod +x ~/twm/info.sh
 sleep 0.5s
fi
...
SERVER="https://raw.githubusercontent.com/OluasArieiv/furiabot/$version/"
